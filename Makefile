...
classes: $(BEAGLE_UTIL_CLASSES:.java=.class) $(BLB_UTIL_CLASSES:.java=.class) $(DAG_CLASSES:.java=.class) $(HAPLOTYPE_CLASSES:.java=.class) $(IBD_CLASSES:.java=.class) $(MAIN_CLASSES:.java=.class) $(SAMPLE_CLASSES:.java=.class) $(VCF_CLASSES:.java=.class) $(SAMTOOLS_CLASSES:.java=.class)
